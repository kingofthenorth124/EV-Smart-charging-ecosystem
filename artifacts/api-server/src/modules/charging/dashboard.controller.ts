...
export class DashboardController {
  ...
  @Permissions("wallet:read", "sessions:read")
  @Get()
  ...
  async getDashboard(
    ...
    const activeSession = await this.chargingService.getActiveSession(
      userId,
      req.correlationId,
    );
    const [wallet, stats, recentSessions, recentTransactions] =
      await Promise.all([
