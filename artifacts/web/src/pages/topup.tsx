        ...
        <div className="max-w-md mx-auto py-10 text-center animate-in fade-in zoom-in duration-500">
          ...
          <p className="text-muted-foreground mb-8">
            ...
            <span className="font-semibold text-foreground">
              {formatNaira(successTx.amountKobo)}
            </span>{" "}
            to your wallet.
          </p>
          ...
          <div className="bg-card border border-border rounded-xl p-5 mb-8 text-left text-sm space-y-3 shadow-sm">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium capitalize">
                {successTx.method?.replace(/_/g, " ").toLowerCase()}
              </span>
            </div>
            <div className="flex justify-between pt-3 border-t border-border">
              ...
              <span className="font-bold text-primary">
                {formatNaira(successTx.balanceAfterKobo)}
              </span>
            </div>
          </div>
      ...
      <div className="max-w-md mx-auto py-2">
            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={`text-xs font-medium ${isSelected ? "font-bold text-primary" : ""}`}
                  >
                    {method.label}
                  </span>
                </button>
        ...
        <div className="bg-card border border-border rounded-xl p-4 mb-6 shadow-sm">
          <div className="flex justify-between text-sm mb-2 text-muted-foreground">
            <span>Amount</span>
            <span>
              {currentAmount > 0 ? formatNaira(currentAmount * 100) : "₦0.00"}
            </span>
          </div>
        ...
        >
          ...
          {isProcessing
            ? "Processing..."
            : `Pay ${currentAmount > 0 ? formatNaira(currentAmount * 100) : ""}`}
        </Button>
      </div>
    </AppLayout>
  );
