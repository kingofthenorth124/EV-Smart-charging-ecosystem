...
describe('ROLE_PERMISSIONS', () => {
  ...
  it('SUPER_ADMIN has all permissions', () => {
    const allPermissions: Permission[] = [
      'wallet:read', 'wallet:topup', 'sessions:read', 'sessions:authorize',
      'sessions:stop', 'nfc:read', 'nfc:manage', 'stations:read',
      'admin:customers', 'admin:stations', 'admin:config', 'developer:portal',
    ];
